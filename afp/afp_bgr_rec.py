...
afp_bgr_fields_list = [
    ...
    StreamFieldAFP(name="Triplets", offset=8, length=32753, type="", optional=True, exception='\x10', range_values=['', '', ''], meaning=['See "BGR Semantics" for', 'triplet applicability.', '']),
    ]
afp_bgr_fields = {}
for field in afp_bgr_fields_list:
    afp_bgr_fields[field.name] = field
...
class AFP_BGR:
    ...
    def __init__(self):
        ...
        self.GdoName = None             #      0       8  CHAR  y         X'02'                            Name of the graphics data
                                        #                                                                  object
        self.Triplets = None            #      8   32753        y         X'10'                            See "BGR Semantics" for
