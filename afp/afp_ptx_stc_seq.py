...
class AFP_PTX_STC:
    ...
    def __init__(self):
        ...
        self.FRGCOLOR = None            #      4       2  CODE                Foreground color                 y    y    y
    ...
    def parse(self, data):
        ...
        """
        self.PREFIX, self.CLASS, self.LENGTH, self.TYPE, self.FRGCOLOR, self.PRECSION = unpack(f">1s1sB1s2s1s", data)
    ...
    def format(self):
        ...
        :returns: Record data
        """
        data = pack(f">1s1sB1s2s1s", self.PREFIX, self.CLASS, self.LENGTH, self.TYPE, self.FRGCOLOR, self.PRECSION)
        return data
