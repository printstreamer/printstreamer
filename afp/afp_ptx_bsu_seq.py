...
afp_ptx_bsu_fields_list = [
    ...
    StreamFieldAFP(name="TYPE", offset=3, length=1, type="CODE", optional=False, range_values=["X'F2' -", ''], default=False, indicator=False, meaning=['Control sequence', '']),
...
class AFP_PTX_BSU:
    ...
    def __init__(self):
        ...
        self.TYPE = None                #      3       1  CODE  X'F2' -       Control sequence                 n    n    n
