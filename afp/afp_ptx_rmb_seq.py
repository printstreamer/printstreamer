...
afp_ptx_rmb_fields_list = [
    ...
    StreamFieldAFP(name="TYPE", offset=3, length=1, type="CODE", optional=True, range_values=["X'D4' -", ''], default=False, indicator=False, meaning=['Control sequence', '']),
...
class AFP_PTX_RMB:
    ...
    def __init__(self):
        ...
        self.TYPE = None                #      3       1  CODE  X'D4' -       Control sequence                 y    n    n
