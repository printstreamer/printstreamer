...
afp_bbc_fields_list = [
    ...
    StreamFieldAFP(name="Triplets", offset=8, length=32753, type="", optional=True, exception='\x10', range_values=['', '', ''], meaning=['See "BBC Semantics" for', 'triplet applicability.', '']),
    ]
afp_bbc_fields = {}
for field in afp_bbc_fields_list:
    afp_bbc_fields[field.name] = field
...
class AFP_BBC:
    ...
    def __init__(self):
        ...
        self.BCdoName = None            #      0       8  CHAR  y         X'02'                            Name of the bar code data
                                        #                                                                  object
        self.Triplets = None            #      8   32753        y         X'10'                            See "BBC Semantics" for
